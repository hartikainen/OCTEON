...
#define CVMX_PKO_QUEUES_PER_PORT_INTERFACE0 2               /**< PKO queues per port for interface 0 (ports 0-15) */
#define CVMX_PKO_QUEUES_PER_PORT_INTERFACE1 2               /**< PKO queues per port for interface 1 (ports 16-31) */
#define CVMX_PKO_QUEUES_PER_PORT_INTERFACE2 2               /**< PKO queues per port for interface 2 */
#define CVMX_PKO_QUEUES_PER_PORT_INTERFACE3 2               /**< PKO queues per port for interface 3 */
#define CVMX_PKO_QUEUES_PER_PORT_INTERFACE4 2               /**< PKO queues per port for interface 4 */
#define CVMX_PKO_MAX_PORTS_INTERFACE0 4                     /**< Limit on the number of PKO ports enabled for interface 0 */
#define CVMX_PKO_MAX_PORTS_INTERFACE1 4                     /**< Limit on the number of PKO ports enabled for interface 1 */
